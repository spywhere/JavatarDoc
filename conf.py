# -*- coding: utf-8 -*-
#
# Javatar documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'Javatar', u'Javatar Documentation',
   u'Sirisak Lueangsaksri', 'Javatar', 'One line description of project.',
   'Miscellaneous'),
]
