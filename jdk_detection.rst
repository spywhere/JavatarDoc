...
At startup time, |J| will automatically detect installed JDK in your computer and select the best one.
...
Here is the steps it take to select the best JDK for most projects...
 ...
 2. Search all JDK directory in installation path (depends on your OS)
